...
echo "  2. App Store Connect: Support URL → ${SUPPORT_URL:-https://github.com/lukefwalton/word-of-the-day/issues}"
echo "  3. Privacy Policy URL → https://github.com/lukefwalton/word-of-the-day/blob/main/docs/privacy.md"
echo "  4. App Privacy: Data Not Collected"
echo "  5. Screenshots: include Home Screen widget"
echo "  6. Review notes: local-only app, no login, widget star works without opening app"
